/*
	*** Edit State Group
	*** src/session/editstategroup.cpp
...
{
	msg.print(Messenger::UndoRedo, "EDITSTATEGROUP: applying group '%s'.\n", qPrintable(title_));
...
{
	msg.print(Messenger::UndoRedo, "EDITSTATEGROUP: reverting group '%s'.\n", qPrintable(title_));
