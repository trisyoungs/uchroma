...
bool Data2D::checkBeforeTransform()
{
	...
	if (x_.nItems() < 5)
	{
		msg.print("Not enough X data points (%i) in Data2D. Can't do transform.\n", x_.nItems());
		return false;
	}
	...
	{
		msg.print("X and Y array sizes do not match (%i vs %i) in Data2D. Can't do transform.\n", x_.nItems(), y_.nItems());
		return false;
	}
	...
	{
		msg.print("Data are unevenly spaced in Data2D. Can't do transform.\n");
		return false;
	}
...
double Data2D::window(Data2D::WindowFunction wf, double x)
{
	...
	switch (wf)
	{
		...
		case (Data2D::SineWindow):
			...
			break;
		default:
			msg.print("Window function %i not implemented.\n", wf);
	}
	return 0.0;
}
...
// 	{
// 		msg.print("X and spline coefficient array sizes do not match (%i vs %i) in Data2D::interpolated().\n", x_.nItems(), splineB_.nItems());
// 		return 0.0;
// 	}
