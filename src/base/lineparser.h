...
#ifndef FQPLOT_LINEPARSER_H
#define FQPLOT_LINEPARSER_H
...
class LineParser
{
	...
	~LineParser();
	// Parse Options
	enum ParseOption { Defaults=0, StripComments=1, UseQuotes=2, SkipBlanks=4, StripBrackets=8, NoEscapes=16, UseBraces=32, NormalCommas=64, DummyOption=128, nParseOptions=9 };
