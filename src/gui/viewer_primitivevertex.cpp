...
{
	plotOrthorhomboid(size, size, size, nsubs, ox, oy, oz);
}
...
void Primitive::plotOrthorhomboid(double sizex, double sizey, double sizez, int nsubs, double ox, double oy, double oz)
{
